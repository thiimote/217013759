...
public class Navigation extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.ic_view) {
            Toast.makeText(getApplicationContext(),"No Gallery to View" ,Toast.LENGTH_LONG).show();

        } else if (id == R.id.ic_edit) {
            // edit username and password
            Toast.makeText(getApplicationContext(),"No record found" ,Toast.LENGTH_LONG).show();

        }  else if (id == R.id.ic_changepassword) {
            // change password
            Intent intent = new Intent(Navigation.this,Setting.class);
            startActivity(intent);

        } else if (id == R.id.ic_changeprofile) {
          // change profile
